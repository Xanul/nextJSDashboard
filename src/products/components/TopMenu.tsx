...
import { CiSearch, CiMenuBurger, CiChat1, CiShoppingCart } from 'react-icons/ci';
...
export const TopMenu = () => {
  ...
  return (
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5 mx-5 mb-3">

      <div className="px-6 flex items-center justify-between space-x-4">
        <h5 hidden className="text-2xl text-gray-600 font-medium lg:block">Tecno Store</h5>
        ...
        <div className="flex space-x-2">
          ...
          >
            {
              (getTotalCount() > 0) && (<span className='text-sm mr-2 text-red-500 font-bold'>{getTotalCount()}</span>)
            }
